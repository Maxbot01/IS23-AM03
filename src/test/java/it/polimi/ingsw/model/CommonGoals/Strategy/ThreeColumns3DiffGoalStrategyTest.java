...
class ThreeColumns3DiffGoalStrategyTest {
    ...
    void testGoalCompleted() {
        ...
        /* Caso funzionante: */
        colorType[] firstLine = {colorType.GREEN,colorType.YELLOW,colorType.GREEN,colorType.LIGHT_BLUE,colorType.GREEN};
        ...
        colorType[] fourthLine = {colorType.GREEN,colorType.LIGHT_BLUE,colorType.BLUE,colorType.BLUE,colorType.BLUE};
        colorType[] fifthLine = {colorType.GREEN,colorType.BLUE,colorType.BLUE,colorType.BLUE,colorType.YELLOW};
        colorType[] sixthLine = {colorType.GREEN,colorType.BLUE,colorType.BLUE,colorType.GREEN,colorType.LIGHT_BLUE};
