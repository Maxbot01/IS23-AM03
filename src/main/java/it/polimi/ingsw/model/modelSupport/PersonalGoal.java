...
public class PersonalGoal {
    ...
    private static final List<Pair<colorType, Pair<Integer, Integer>>> seventh = Arrays.asList(new Pair<>(colorType.WHITE, new Pair<>(5, 2)), new Pair<>(colorType.YELLOW, new Pair<>(4, 5)), new Pair<>(colorType.LIGHT_BLUE, new Pair<>(3, 0)), new Pair<>(colorType.PURPLE, new Pair<>(2, 1)), new Pair<>(colorType.BLUE, new Pair<>(1, 3)), new Pair<>(colorType.GREEN, new Pair<>(0, 0)));
